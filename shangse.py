...
def args_initialize():
    ...
    parser.add_argument('--batch_size', type=int, default=6, help='batch的尺寸')
    parser.add_argument('--time_step', type=int, default=500, help='t的最大取值， t是扩散模型的扩散步数')
    parser.add_argument('-lr', '--learning_rate', type=int, default=0.00005, help='学习率')
    ...
    for epoch in range(args.epoch):
        ...
        for datas in loader_train:
            ...
            if step % args.save_net_para_step == 0:
                ...
                torchvision.utils.save_image(torch.cat((y.repeat(1, 3, 1, 1), imgs), 0), filename, nrow=5)
                diff.check_out()
